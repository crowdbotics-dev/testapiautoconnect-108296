...
## Project Structure
    ...
    ├── testapiautoconnect_108296  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_108296`
...
2. Clone this repo and `cd testapiautoconnect_108296`
